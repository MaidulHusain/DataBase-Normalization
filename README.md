...
### Installation 
You have to install MySQL Workbench in your machine, you can follow the following link to install the MySQL Workbench
...
- Sixth Normal Form 
# Objective:
In this project I will focus on the first three normalizing process in database, and other forms are out of the scope of this projects.
# Methodology
## First Normal Form
...
### Contributor Info
- Md Maidul Husain
  - <mdmaidul.husain@student.nmt.edu>
  - <mhusain@isrt.ac.bd>
